...
public class LessonResponse extends DtoWithUniqueName {
    ...
    public LessonResponse(int id, String name, Group group, Teacher teacher, Course course, LessonType lessonType,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LessonResponse)) return false;
